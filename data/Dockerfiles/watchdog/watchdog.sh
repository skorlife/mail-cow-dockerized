...
if [[ -z "${DBCONNECTION}" || "${DBCONNECTION}" == "unix" ]]; then
    ...
    DBCONNECTION_STR_NRPE="-s /var/run/mysqld/mysqld.sock"
    DBCONNECTION_STR_SLAVE="-S /var/run/mysqld/mysqld.sock"
else
    DBCONNECTION_STR="--host=${DBCONNECTION}"
    DBCONNECTION_STR_NRPE="-H ${DBCONNECTION}"
    DBCONNECTION_STR_SLAVE="-H ${DBCONNECTION}"
fi
